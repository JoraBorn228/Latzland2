    ...
    <div className="relative pl-11 sm:pl-14 mb-3.5 group" id={`event-${event.id}`}>
      ...
      >
        ...
        <div
          ...
          className="flex items-start sm:items-center justify-between gap-2.5 sm:gap-3 p-3 sm:p-4 pl-4 sm:pl-5 select-none cursor-pointer focus:outline-none focus:bg-white/[0.04]"
        >
          <div className="flex items-start sm:items-center gap-2.5 sm:gap-3 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2 text-xs text-neutral-400 mb-0.5">
                ...
                {event.important && (
                  <span
                    className="inline-flex items-center gap-0.5 text-[#ffd700] text-[11px] font-semibold"
                    title="Важная веха"
                  >
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0 pt-0.5 sm:pt-0">
            ...
            {isAdmin && (
              <div
                className="flex items-center gap-1 bg-black/40 border border-amber-500/30 rounded-lg p-0.5 mr-1"
            ...
            <div
              className={`text-neutral-400 hover:text-white p-1 rounded transition-transform duration-200 ${
